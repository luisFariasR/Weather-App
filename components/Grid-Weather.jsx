export default function GridWeather(params) {
  return (
    <div className="bg-slate-950 pl-20">
      <div className="degrees flex justify-end gap-10 pr-20 pt-15 pb-6">
        <button className="bg-slate-100 w-[3rem] h-[3rem] rounded-4xl">°C</button>
        <button className="bg-slate-500 w-[3rem]  rounded-4xl">°F</button>
      </div>
